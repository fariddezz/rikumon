...
function random(min, max) {
    ...
    function pushKey(e) {
        ...
        console.log(petPlayerObject.speedX, petPlayerObject.speedY)
    }
    ...
    function drawCanvas(){
        ...
        // Comprobar velocidad máxima horizontal
        if (petPlayerObject.speedX > 5) {
        petPlayerObject.speedX = 5;
        } else if (petPlayerObject.speedX < -5) {
        petPlayerObject.speedX = -5;
        }
    
        // Comprobar velocidad máxima vertical
        if (petPlayerObject.speedY > 5) {
            petPlayerObject.speedY = 5;
        } else if (petPlayerObject.speedY < -5) {
            petPlayerObject.speedY = -5;
        }
        clearCanvas()
        canvas.drawImage(
