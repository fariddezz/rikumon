...
function random(min, max) {
    ...
    function drawCanvas(){
        ...
        if (petPlayerObject.x === intialPositionX || petPlayerObject.y === intialPositionY ||petPlayerObject.speedX !== 0 || petPlayerObject.speedY !== 0){
            intialPositionX = "A"
            intialPositionY = "E"
            clearCanvas()
            canvas.drawImage(
    ...
    function disabledPets(G){
        ...
        intialPositionX = extractPetPlayer(petselected).x
        intialPositionY = extractPetPlayer(petselected).y
