 ...
 inputThornhydro = document.getElementById('Thornhydro')
    ...
    function extractAttacks(A){
        ...
        function createMessage(){
            ...
            new_player_attack.innerHTML = attacksOfPlayer
            new_enemy_attack.innerHTML = attacksOfEnemy
        ...
        function combat(){
            ...
            if(attacksOfPlayer == attacksOfEnemy){
               resultOfCombat = "TIE🤌"
            } else if(attacksOfPlayer == pyro && attacksOfEnemy == electro || attacksOfPlayer == electro && attacksOfEnemy == hydro || attacksOfPlayer == hydro && attacksOfEnemy == pyro){
