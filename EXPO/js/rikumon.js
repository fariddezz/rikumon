...
function joinToGame(){
    fetch("http://192.168.1.9:3000/join")
...
function checkerPetBackground(M){
    fetch(`http://192.168.1.9:3000/rikumon/${playerID}`,{
        method: 'POST',
        headers: {
...
function sendPosition(x, y){
    fetch(`http://192.168.1.9:3000/rikumon/${playerID}/position`,{
        method: 'POST',
        headers: {
            "content-type": "application/json"
        },
...
function sendAttacks(elpp){
    fetch(`http://192.168.1.9:3000/rikumon/${playerID}/attacks`,{
        method: 'POST',
        headers: {
            "content-type": "application/json"
        },
...
function getAttacks(){
    fetch(`http://192.168.1.9:3000/rikumon/${enemyID}/attacks`)
        .then(function (response) {
            if (response.ok) {
                response.json()
                    .then
